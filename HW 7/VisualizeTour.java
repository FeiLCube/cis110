/*************************************************************************
  ...
  *  Dependencies: Tour.java Coordinate.java In.java PennDraw.java
  *
  *  Constructs a Tour from a file, inserting Coordinates in order, using the
  *  nearest insertion heuristic, or the smallest insertion heuristic,
  *  or asks the user for each Coordinate.
...
public class VisualizeTour {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (!inFile.isEmpty()) {
                ...
                // insert next Coordinate with the specified mode
    ...
    private static char getMode(String filename) {
        ...
        msgl(17.0/20, "Press");
        msgl(16.0/20, "o to add all Coordinate using your insertInOrder()");
        msgl(15.0/20, "n to add all Coordinate using your insertNearest()");
        msgl(14.0/20, "s to add all Coordinate using your insertSmallest()");
        msgl(13.0/20, "i to ask for each Coordinate");
        while (true) {
            if (PennDraw.hasNextKeyTyped()) {
    ...
    private static boolean getAnimationMode() {
        msgl(19.0/20, "Press");
        msgl(18.0/20, "y to animate the insertion of each Coordinate;");
    ...
    private static void displayInteractiveModeInstructions() {
        ...
        msgl(18.0/20, "o to add the next Coordinate using your insertInOrder()");
        msgl(17.0/20, "n to add the next Coordinate using your insertNearest()");
        msgl(16.0/20, "s to add the next Coordinate using your insertSmallest()");
        msgl(15.0/20, "p to skip the next Coordinate");
    ...
    public static void drawTour(TourInterface tour, Coordinate p) {
        PennDraw.clear();
